...
class GoalActionClient(Node):
    ...
    def send_goal(self):
        ...
        goal_msg.pose.pose.position.x = 8.943
        goal_msg.pose.pose.position.y = -0.532
        goal_msg.pose.pose.orientation.w = 0.999498
        goal_msg.pose.pose.orientation.z = 0.011824
