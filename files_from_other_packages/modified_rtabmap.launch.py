...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('topic_queue_size', default_value='3000',               description='Queue size of individual topic subscribers.'),
        DeclareLaunchArgument('queue_size',     default_value='3000',                 description='Backward compatibility, use "sync_queue_size" instead.'),
